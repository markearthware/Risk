    ...
    function initTables() {
        ...
        checkTableExists("Controls", function(tx) {
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS Controls (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, Name, HazardId)', [], function(tx, result) {
                ...
                tx.executeSql('INSERT INTO Controls (Name,HazardId) VALUES ("(Radiological)",13)');
                ...
                tx.executeSql('INSERT INTO Controls (Name,HazardId) VALUES ("Work in accordance with Competent Advice",19)');
                ...
                tx.executeSql('INSERT INTO Controls (Name,HazardId) VALUES ("Level manually operated to contain run-off",42)');
