steal('jquery/model', function () {
    ...
    Risk.Models.WebSqlModel('Risk.Models.AssessmentsB',
  {
      ...
      findOne: function (id) {
          var result = localStorageDB.getSingleRow('SELECT ass.id, ass.TaskId, ass.FurtherDetails, ass.Likelihood, ass.Severity, h.Name as How, w.Name as Who, h.id as HowId, w.id as WhoId, hz.Name as Hazard FROM Assessments as ass inner join Hazards as hz on ass.HazardId = hz.Id inner join Whos as w on ass.WhoId = w.id inner join Hows as h on ass.HowId = h.id WHERE ass.id =' + id, this);
